...
export function groupGoodsSort(data) {
  return request({
    url: '/lmp/admin/api/group/goods/sort',
    method: 'post',
    data
  })
}
...
export function delGrouping(data) {
  return request({
    url: `/lmp/admin/api/group/deleteGrouping/${data}`,
    method: 'delete',
    data
  })
}
...
export function addGoodsToGroup(data) {
  return request({
    url: '/lmp/admin/api/group/addGoods',
    method: 'post',
    data
  })
}
export function show(params) {
  return request({
    url: `/lmp/admin/api/group/info/${params.id}`,
    method: 'get',
  })
}
