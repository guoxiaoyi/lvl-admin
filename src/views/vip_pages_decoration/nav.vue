      ...
      <div class="panel-body">
        <div class="flex">
          ...
          <div class="home_page_edit">
            ...
            <div v-if="!nav_data.isDefault && checkPer(['vip_pages_decoration_manage', 'points_pages_decoration_manage'])" class="add_nav" :class="{disabled: nav_data.list.length >= 5}" @click="add"> 添加导航 </div>
            <hr>
            <el-button v-if="checkPer(['vip_pages_decoration_manage', 'points_pages_decoration_manage'])" type="success" :loading="submitting" @click="submit">保存</el-button>
          </div>
        </div>
      </div>
    </div>
