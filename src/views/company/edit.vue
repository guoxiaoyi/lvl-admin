      ...
      <div class="panel-body">
        ...
        <el-form ref="form" size="small" label-width="16.6666%" :rules="rules" :model="form">
          <el-form-item label="企业全称">
            <el-input v-model="form.cFullname" type="text" disabled />
            <p class="help-block">与企业工商营业执照上一致。</p>
          </el-form-item>
          <el-form-item label="法定代表人/企业负责人姓名">
            <el-input v-model="form.cLegalPerson" type="text" disabled />
            <p class="help-block">与企业工商营业执照上一致。</p>
          </el-form-item>
          <el-form-item label="营业执照号/统一社会信用代码">
            <el-input v-model="form.cRegisteredCode" type="text" disabled />
          ...
          <el-form-item label="企业工商营业执照">
            <img
              ...
              class="img-thumbnail"
              :src="form.cRegisteredCodeImageUrl"
            >
