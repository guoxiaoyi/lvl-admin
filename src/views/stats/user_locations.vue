<template>
  <div class="app-container">
    <ul class="nav nav-tabs">
      <li class="active">
        <a aria-current="page" href="javascript:;"> 地域分析 </a>
      </li>
    </ul>
      ...
      <div class="panel-body">
        ...
        <div class="panel panel-default">
          ...
          <el-table :data="viewDatas">
            <el-table-column label="地区" prop="label" />
            <el-table-column label="新增用户" prop="num" />
            <el-table-column label="新增用户占比" prop="ratio" />
            <el-table-column label="累计用户占比" prop="totalAndRatio" />
          </el-table>
        </div>
        <el-pagination
          :page-sizes="[20]"
