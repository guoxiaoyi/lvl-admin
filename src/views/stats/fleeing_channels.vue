      ...
      <div class="panel-body">
        ...
        <div class="panel panel-default">
          ...
          <el-table v-loading="crud.loading" :data="crud.data">
            ...
            <el-table-column label="渠道类型" prop="type" />
...
export default {
  ...
  cruds() {
    return CRUD({ title: '窜货渠道分析', url: '/lmp/v2/admin/fleeing/channels', query: {
  ...
  async mounted() {
    this.$store.dispatch('breadcrumb/set_breadcrumb', [{ title: '窜货渠道分析' }])
